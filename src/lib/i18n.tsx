...
const dictionaries: Record<Language, TranslationDictionary> = {
  en: {
    ...
    aiConfig: {
      eyebrow: "AI Search Prompt",
      title: "Tune destination resolution",
      subtitle: "Edit the full prompt, test it immediately, then sync the approved version to the backend.",
      save: "Save",
      saving: "Saving…",
      revert: "Revert",
      syncToBackend: "Sync to backend",
      saved: "Prompt synced to backend.",
      ...
      testQueryRequired: "Enter a company, school, campus, office nickname, or address to test.",
      ...
      promptEditor: "Prompt",
      promptEditorPlaceholder: "Sync the live backend prompt, edit it here, then test before saving.",
      promptEditorHint: "Testing uses this textarea directly and skips the destination cache. Sync to backend only when you like the result.",
      ...
      promptSourceHint: "Sync from the deployed Edge Function to load the current destination resolver prompt.",
      syncPrompt: "Sync from backend",
  ...
  zh: {
    ...
    aiConfig: {
      eyebrow: "AI Search Prompt",
      title: "调整地址解析 prompt",
      subtitle: "直接编辑完整 prompt，立刻测试，确认后再同步到后端。",
      save: "保存",
      saving: "保存中…",
      revert: "撤销",
      syncToBackend: "同步到后端",
      ...
      promptRequired: "Prompt 不可以为空。",
      testQueryRequired: "请输入要测试的公司、学校、校区、office 昵称或地址。",
      ...
      prompts: "AI Search Prompt",
      promptEditor: "Prompt",
      promptEditorPlaceholder: "先从后端同步当前 prompt，在这里修改，然后测试并保存。",
      promptEditorHint: "测试会直接使用这个 textarea 的内容，并跳过地址缓存。确认效果后再同步到后端。",
      ...
      promptSourceHint: "从已部署的 Edge Function 同步当前地址解析 prompt。",
      syncPrompt: "从后端同步",
      syncingPrompt: "同步中…",
