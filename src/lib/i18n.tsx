...
const dictionaries: Record<Language, TranslationDictionary> = {
  en: {
    ...
    aiConfig: {
      ...
      subtitle: "Edit the current server prompt, test it immediately, then save it.",
      save: "Save",
      saving: "Saving…",
      revert: "Revert",
      syncToBackend: "Save",
      saved: "Prompt saved on the server.",
      ...
      promptEditor: "Prompt",
      promptEditorPlaceholder: "Edit the current server prompt here.",
      promptEditorHint: "Testing uses this textarea directly and skips the destination cache. Save when you like the result.",
  ...
  zh: {
    ...
    aiConfig: {
      eyebrow: "AI Search Prompt",
      title: "调整地址解析 prompt",
      subtitle: "直接编辑当前服务器 prompt，立刻测试，确认后保存。",
      save: "保存",
      saving: "保存中…",
      revert: "撤销",
      syncToBackend: "保存",
      saved: "Prompt 已保存到服务器。",
      ...
      prompts: "AI Search Prompt",
      promptEditor: "Prompt",
      promptEditorPlaceholder: "在这里编辑当前服务器 prompt。",
      promptEditorHint: "测试会直接使用这个 textarea 的内容，并跳过地址缓存。确认效果后保存。",
