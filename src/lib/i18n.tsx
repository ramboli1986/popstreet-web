...
const dictionaries: Record<Language, TranslationDictionary> = {
  en: {
    views: {
      ...
      accounts: "Accounts",
      aiConfig: "AI Config",
      aiDestinations: "Commute Destinations"
    },
    nav: {
      dashboard: "Dashboard",
      building: "Buildings",
    ...
    aiDestinations: {
      eyebrow: "Commute destination table",
      title: "Commute destinations · {count} records",
      subtitle: "Review and maintain resolved company/school addresses plus nearby subway and PATH lines used for commute matching.",
      add: "Add destination",
      viewerOnly: "Read-only - editor role or higher can maintain commute destinations.",
      search: "Search company, address, place ID, line...",
      allKinds: "All kinds",
      allLines: "All lines",
      destinations: "destinations",
      transitLines: "lines",
      list: "Resolved addresses",
      tableTitle: "Company and school addresses",
      empty: "No commute destinations found.",
      query: "Query",
      ...
      provider: "Provider",
      updated: "Updated",
      drawerEyebrow: "Commute destination",
      newDestination: "New destination",
      queryProfile: "Search source",
      destinationProfile: "Address profile",
      placeId: "Place ID",
      ...
      latitude: "Latitude",
      longitude: "Longitude",
      transitLineManager: "Nearby subway/PATH lines",
      transitLineHint: "Used by direct-subway matching when a user chooses subway/direct transit commute.",
      deleteDestination: "Delete destination",
      saveDestination: "Save destination",
      required: "Query, name, address, and Place ID are required.",
      saved: "Commute destination saved.",
      deleted: "Commute destination deleted.",
  ...
  zh: {
    views: {
      ...
      map: "地图",
      applications: "申请",
      availabilityCrawler: "可租爬虫",
      mobileUsers: "Mobile 用户",
      accounts: "账号",
      aiConfig: "AI 配置",
      aiDestinations: "通勤目的地"
    },
    nav: {
      dashboard: "总览",
      building: "大楼",
    ...
    aiDestinations: {
      eyebrow: "通勤目的地表",
      title: "通勤目的地 · {count} 条",
      subtitle: "查看和维护已解析的公司/学校地址，以及附近地铁和 PATH 线路，用于通勤匹配。",
      add: "添加地址",
      viewerOnly: "只读模式 - editor 或更高权限可以维护通勤目的地。",
      search: "搜索公司、地址、Place ID、线路...",
      allKinds: "全部类型",
      allLines: "全部线路",
      destinations: "地址",
      transitLines: "线路",
      ...
      latitude: "纬度",
      longitude: "经度",
      transitLineManager: "附近地铁/PATH 线路",
      transitLineHint: "当用户选择地铁直达通勤时，用这里的线路和大楼附近线路做匹配。",
      deleteDestination: "删除地址",
      saveDestination: "保存地址",
      required: "Query、显示名称、地址、Place ID 必填。",
      saved: "通勤目的地已保存。",
      deleted: "通勤目的地已删除。",
