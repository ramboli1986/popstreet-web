...
const dictionaries: Record<Language, TranslationDictionary> = {
  en: {
    ...
    aiDestinations: {
      ...
      subtitle: "Maintain cached work and school destination results plus the aliases that make repeat searches fast.",
      add: "Add destination",
      viewerOnly: "Read-only — editor role or higher can maintain the AI destination cache.",
      search: "Search destination, address, alias...",
      ...
      cacheRecords: "Cached commute destinations",
      ...
      saved: "AI destination saved.",
      deleted: "AI destination deleted.",
      ...
      deleteConfirm: "Delete {name}? Its aliases will also be removed.",
      work: "Work",
      school: "School"
    }
  },
  zh: {
    ...
    aiDestinations: {
      ...
      subtitle: "维护工作/学校地址解析结果，以及让重复搜索变快的 alias。",
      add: "添加地址",
      viewerOnly: "只读模式 —— editor 或更高权限可以维护 AI 地址缓存。",
      search: "搜索地址、名称、alias...",
      allStatuses: "全部状态",
      activeOnly: "仅启用",
      inactiveOnly: "仅停用",
      allKinds: "全部类型",
      ...
      deleteConfirm: "删除 {name}？对应 aliases 也会一起删除。",
      work: "工作",
      school: "学校"
    }
  }
